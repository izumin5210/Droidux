...
import info.izumin.android.droidux.example.counter.R;
...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction textView = onView(
                allOf(withId(R.id.text_counter), withText("0"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.text_counter), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView6 = onView(
                allOf(withId(R.id.text_counter), withText("2"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
