...
public final class Source {
    ...
    public static class CombinedTwoReducers {
        ...
        public static final String[] GENERATED = {
                ...
                "        super(builder);",
                "        this.counterReducer = builder.counterReducer;",
                "        this.counterStore = new DroiduxCounterStore.Builder().setReducer(counterReducer).addInitialState(builder.counter).build();",
                "        addStore(counterStore);",
                "        this.todoListReducer = builder.todoListReducer;",
                "        this.todoListStore = new DroiduxTodoListStore.Builder().setReducer(todoListReducer).addInitialState(builder.todoList).build();",
